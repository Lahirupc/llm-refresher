...
def create_base_vectorstore():
    ...
    return Chroma.from_documents(
        documents=TECH_DOCS,
        embedding=OpenRouterEmbeddings(model="liquid/lfm-2.5-embedding-350m:free"),
    )
...
LangSmith provides observability for LangChain/LangGraph applications, offering tracing, evaluation, and monitoring capabilities.
    ...
    vectorstore = Chroma(
        ...
        embedding_function=OpenRouterEmbeddings(model="liquid/lfm-2.5-embedding-350m:free"),
    )
    store = InMemoryStore()
